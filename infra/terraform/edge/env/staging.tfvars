# staging — Cloudflare edge. Committed: nothing here is sensitive.
#
# account_id and zone_id are identifiers, not credentials, but they are still
# kept out of a public repository. They live in staging.secrets.tfvars, which is
...
# app-staging.xenopsoftware.com is covered; staging.app.xenopsoftware.com is not.
hostname = "app-staging.xenopsoftware.com"
