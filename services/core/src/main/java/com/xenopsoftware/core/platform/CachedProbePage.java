...
/**
 * One page of probe metadata, in the shape that is safe to put in Valkey (T-3.22, #264).
 *
 ...
 *
 * <p>It also lives in the service layer rather than reusing {@code PlatformProbeResource.ProbeView},
 ...
 *
 * <p>The bytes of the probe are not here and never will be -- ADR-0011's never-cache list is
...
public record CachedProbePage(List<CachedProbe> content, long totalElements) {
    /**
     * One probe's metadata.
     *
     ...
     */
    @JsonIgnoreProperties(ignoreUnknown = true)
    public record CachedProbe(Long id, String label, String contentType, Long sizeBytes, String status, Instant createdAt) {}
}
